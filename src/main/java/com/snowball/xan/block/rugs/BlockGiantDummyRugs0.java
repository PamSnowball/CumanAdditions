...
public class BlockGiantDummyRugs0 extends XanObjects.ModElement {
	
	@GameRegistry.ObjectHolder("xan:giantdummyrugs0")
	public static final Block block = null;
	public BlockGiantDummyRugs0(XanObjects instance) {
		super(instance, 21);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("giantdummyrugs0"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xan:giantdummyrugs0", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("giantdummyrugs0");
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			if (((new Object() {
				...
				if ((((world.getBlockState(new BlockPos((x + 1), y, z))).getBlock() == BlockGiantDummyRugs0.block.getDefaultState().getBlock())
						|| ((world.getBlockState(new BlockPos((x + 1), y, z))).getBlock() == BlockGiantRugs0.block.getDefaultState()
								.getBlock()))) {
			...
			if (((new Object() {
				...
				if ((((world.getBlockState(new BlockPos(x, y, (z + 1)))).getBlock() == BlockGiantDummyRugs0.block.getDefaultState().getBlock())
						|| ((world.getBlockState(new BlockPos(x, y, (z + 1)))).getBlock() == BlockGiantRugs0.block.getDefaultState()
								.getBlock()))) {
					world.setBlockToAir(new BlockPos(x, y, (z + 1)));
					world.setBlockToAir(new BlockPos((x - 1), y, (z + 1)));
