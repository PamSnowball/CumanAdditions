...
public class BlockWideRugs extends XanObjects.ModElement {
	
	@GameRegistry.ObjectHolder("xan:widerugs")
	public static final Block block = null;
	public BlockWideRugs(XanObjects instance) {
		super(instance, 20);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("widerugs"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xan:widerugs", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			...
			if (((world.isAirBlock(new BlockPos(x, y, (z + 1))))
					&& (!(world.isAirBlock(new BlockPos(x, (y - 1), (z + 1))))))) {
				Spot3 = (boolean) (true);
			}
			if (((world.isAirBlock(new BlockPos((x + 1), y, z)))
					&& (!(world.isAirBlock(new BlockPos((x + 1), (y - 1), z)))))) {
			...
			if (((((Spot4) == (false)) && ((Spot1) == (true))) && (((Spot2) == (false)) && ((Spot3) == (false))))) {
				...
				world.setBlockState(new BlockPos(x, y, (z - 1)), BlockWideDummyRugs.block.getDefaultState(), 3);
				try {
			...
			if (((((Spot4) == (false)) && ((Spot1) == (false))) && (((Spot2) == (true)) && ((Spot3) == (false))))) {
				...
				world.setBlockState(new BlockPos((x - 1), y, z), BlockWideDummyRugs.block.getDefaultState(), 3);
				try {
