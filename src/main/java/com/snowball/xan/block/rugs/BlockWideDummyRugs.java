...
public class BlockWideDummyRugs extends XanObjects.ModElement {
	
	@GameRegistry.ObjectHolder("xan:widedummyrugs")
	public static final Block block = null;
	public BlockWideDummyRugs(XanObjects instance) {
		super(instance, 21);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("widedummyrugs"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xan:widedummyrugs", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("widedummyrugs");
