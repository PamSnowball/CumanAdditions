...
public class BlockGiantDummyRugs2 extends XanObjects.ModElement {
	...
	@GameRegistry.ObjectHolder("xan:giantdummyrugs2")
	public static final Block block = null;
	public BlockGiantDummyRugs2(XanObjects instance) {
		super(instance, 21);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("giantdummyrugs2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xan:giantdummyrugs2", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("giantdummyrugs2");
