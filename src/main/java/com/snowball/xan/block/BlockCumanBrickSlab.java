...
public class BlockCumanBrickSlab extends XanObjects.ModElement {
	@GameRegistry.ObjectHolder("xan:cuman_brick_double_slab")
	public static final Block block_slab_double = null;
	@GameRegistry.ObjectHolder("xan:cuman_brick_slab")
	public static final Block block = null;
	
	public BlockCumanBrickSlab(XanObjects instance) {
		super(instance, 7);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cuman_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cuman_brick_double_slab"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xan:cuman_brick_slab", "inventory"));
	}

	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("cuman_brick_slab");
